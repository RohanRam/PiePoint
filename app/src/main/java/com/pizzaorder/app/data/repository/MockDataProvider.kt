package com.pizzaorder.app.data.repository

import com.pizzaorder.app.R
import com.pizzaorder.app.data.model.*
...
object MockDataProvider {
    ...
    val categories = listOf(
        ...
        PizzaCategory("cat2", "Burger", "\uD83C\uDF54"),
        PizzaCategory("cat3", "Pasta", "\uD83C\uDF5D"),
        PizzaCategory("cat4", "Salad", "\uD83E\uDD57"),
        PizzaCategory("cat5", "Drinks", "\uD83E\uDD64")
    )
